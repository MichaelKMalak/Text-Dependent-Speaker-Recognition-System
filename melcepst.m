...
%	  ##Youssef TA note : The next 4 parameters (p,inc,fl,fh) should be set to default values
...
%		##Youssef TA note : you should only care about the first option : ie you should put w 
%		##as 'M' if you want to frame using hamming window or 'R' if you want rectangular. 
%		##Leave others to default values
%				'R'  rectangular window in time domain
%				'N'	Hanning window in time domain
%				'M'	Hamming window in time domain (default)
%------------------------------------------------------------------------------------
%		##Youssef TA note : No need to read the next comments. Leave them to default values.
